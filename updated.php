...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE wisata SET name='$name', alamat='$alamat', category='$category' ,body='$body', gambar='$nama_gambar', operasional='$operasional' WHERE id = $id";
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container-md mx-5 my-5">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <input value="<?= $result['id'] ?>" name="id" style="width: 80%;" type="hidden" class="form-control" id="name" placeholder="Balekambang" required>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3" style="width: 80%;">
                                        <input name="operasional" value="<?= $result['operasional'] ?>" type="time" class=" form-control" id="operasional" placeholder="Fast.jpg" required>
                                    </div>
